/*
	...
	Question Link - https://platform.stratascratch.com/coding/10322-finding-user-purchases?code_type=5
*/
...
INSERT INTO Sales (id, user_id, item, created_at, revenue)
VALUES
...
AND s1.id <> s2.id
WHERE ABS(DATEDIFF(DAY, s1.created_at, s2.created_at)) <=7
ORDER by s1.user_id 
